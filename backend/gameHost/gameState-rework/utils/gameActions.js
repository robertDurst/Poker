...
function getAllPlayerPackages() {
  const packages = this.order.map( (id) => {
    return Object.assign({},this.players[id])
  })
  return packages
}
//Create single player package
function getPlayerPackage() {
  return this.players[id]
}
//Public Package
function getPublicPackage() {
  const package = {
    spread: this.hand.spread,
