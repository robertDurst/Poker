...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _electronWindowState = __webpack_require__(329);
	...
	var _observe = __webpack_require__(346);
	
	var _observe2 = _interopRequireDefault(_observe);
	
	var _child_process = __webpack_require__(350);
	
	var _child_process2 = _interopRequireDefault(_child_process);
	
	var _psNode = __webpack_require__(351);
	
	var _psNode2 = _interopRequireDefault(_psNode);
	
	var _electronLog = __webpack_require__(358);
	
	var _electronLog2 = _interopRequireDefault(_electronLog);
	
	var _os = __webpack_require__(357);
	
	var _os2 = _interopRequireDefault(_os);
	
	var _fs = __webpack_require__(332);
	
	var _fs2 = _interopRequireDefault(_fs);
	
	var _grpc = __webpack_require__(373);
	
	var _grpc2 = _interopRequireDefault(_grpc);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_electron.app.commandLine.appendSwitch('remote-debugging-port', '9997'); /* eslint-disable global-require, no-console */
	
	_electron.app.commandLine.appendSwitch('host-rules', 'MAP * 127.0.0.1');
	
	var mainWindow = null;
	var isDev = ("production") === 'development';
	var runningProcesses = [];
	
	var isProcessRunning = function isProcessRunning(command) {
	  return new Promise(function (resolve, reject) {
	    _psNode2.default.lookup({ command: command }, function (err, resultList) {
	      if (err) {
	        throw new Error(err);
	      }
	...
	var runProcesses = function runProcesses(processes, logs) {
	  _lodash2.default.map(processes, function (proc) {
	    isProcessRunning(proc.name).then(function () {
	      console.log(proc.name + ' Already Running');
	      logs.push(proc.name + ' Already Running');
	      _electronLog2.default.info(proc.name + ' Already Running');
	    }).catch(function () {
	      var plat = _os2.default.platform();
	      var filePath = _path2.default.join(__dirname, 'bin', plat, plat === 'win32' ? proc.name + '.exe' : proc.name);
	
	      try {
	        var instance = _child_process2.default.spawn(filePath, proc.args);
	        runningProcesses.push(instance);
	        instance.stdout.on('data', function (data) {
	          return logs.push(proc.name + ': ' + data);
	        });
	        instance.stderr.on('data', function (data) {
	          logs.push(proc.name + ' Error: ' + data);
	          _electronLog2.default.error(proc.name + ': ' + data);
	        });
	      } catch (error) {
	...
	var logBuffer = [];
	var logs = (0, _observe2.default)(logBuffer);
	
	var processes = [{
	  name: 'lnd',
	  args: [isDev ? '' : '--bitcoin.active', isDev ? '' : '--neutrino.active', isDev ? '' : '--configfile=../lnd.conf', isDev ? '' : '--bitcoin.testnet', isDev ? '' : '--neutrino.connect=btcd0.lightning.computer:18333', isDev ? '' : '--neutrino.connect=127.0.0.1:18333', isDev ? '' : '--debuglevel=info', isDev ? '' : '--autopilot.active', '--no-macaroons', '--noencryptwallet']
	}];
	...
	switch (_os2.default.platform()) {
	  case 'darwin':
	    certPath = _path2.default.join(homedir, 'Library/Application\ Support/Lnd/tls.cert');
	    break;
	  case 'linux':
	    certPath = _path2.default.join(homedir, '.lnd/tls.cert');
	    break;
	  case 'win32':
	    certPath = _path2.default.join(homedir, 'AppData', 'Local', 'Lnd', 'tls.cert');
	    break;
	  default:
	    break;
	}
	
	var finishCreateWindow = function finishCreateWindow() {
	  ...
	  var icon = 'assets/ln-logo' + ({
	    'darwin': '.icns',
	    'win32': '.ico'
	  }[plat] || '.png');
	
	  var x = mainWindowState.x,
	      y = mainWindowState.y,
	  ...
	  logs.on('change', function (change) {
	    var log = logBuffer[change.index];
	    logQueue.push(log);
	  });
	  ...
	  var template = [{
	    label: 'Lightning',
	    submenu: [{ label: 'Quit', accelerator: 'Command+Q', click: function click() {
	        _electron.app.quit();
	      }
	    }]
	  }, {
	  ...
	  !isDev && _electron.Menu.setApplicationMenu(_electron.Menu.buildFromTemplate(template));
	};
	
	var createWindow = function createWindow() {
	  intervalId = setInterval(function () {
	    if (_fs2.default.existsSync(certPath)) {
	      clearInterval(intervalId);
	      var lndCert = _fs2.default.readFileSync(certPath);
	      var credentials = _grpc2.default.credentials.createSsl(lndCert);
	
	      var _grpc$load = _grpc2.default.load(_path2.default.join(__dirname, 'rpc.proto')),
	          lnrpc = _grpc$load.lnrpc;
	
	      var connection = new lnrpc.Lightning('localhost:10009', credentials);
	      var serverReady = function serverReady(cb) {
	        return _grpc2.default.waitForClientReady(connection, Infinity, cb);
	      };
	...
	__webpack_require__(374)({ enabled: true });
	...
	_electron.app.on('quit', function () {
	  runningProcesses.forEach(function (proc) {
	    return proc.kill();
	  });
	});
	...
	process.on('uncaughtException', function (error) {
	  ...
	  _electronLog2.default.error('Main Process: ' + error);
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var electron = __webpack_require__(327);
	var jsonfile = __webpack_require__(330);
	var mkdirp = __webpack_require__(340);
	var deepEqual = __webpack_require__(341);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fs
	try {
	  _fs = __webpack_require__(331)
	} catch (_) {
	  _fs = __webpack_require__(332)
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var legacy = __webpack_require__(336)
	var queue = []
	...
	if (/\bgfs4\b/i.test(({"NODE_ENV":"production"}).NODE_DEBUG || '')) {
	  process.on('exit', function() {
	    debug(queue)
	    __webpack_require__(339).equal(queue.length, 0)
	  })
	}
	
	module.exports = patch(__webpack_require__(334))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var objectKeys = __webpack_require__(342);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var proto = __webpack_require__(347)
	var EventEmitter = __webpack_require__(348).EventEmitter
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChildProcess = __webpack_require__(350);
	var IS_WIN = process.platform === 'win32';
	var TableParser = __webpack_require__(353);
	/**
	 * End of line.
	 ...
	 */
	var EOL = /(\r\n)|(\n\r)|\n|\r/;
	var SystemEOL = __webpack_require__(357).EOL;
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var ConnectedDomain = __webpack_require__(355);
	var EMPTY_EX = /\s/;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var originalConsole = __webpack_require__(360);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var log                      = __webpack_require__(362);
	var transportConsole         = __webpack_require__(363);
	var transportFile            = __webpack_require__(365);
	var transportLogS            = __webpack_require__(368);
	var transportRendererConsole = __webpack_require__(372);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var format          = __webpack_require__(364);
	var originalConsole = __webpack_require__(360);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var util = __webpack_require__(338);
	var EOL  = __webpack_require__(357).EOL;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EOL              = __webpack_require__(357).EOL;
	var format           = __webpack_require__(364);
	var consoleTransport = __webpack_require__(363);
	var findLogPath      = __webpack_require__(366);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fs   = __webpack_require__(332);
	var path = __webpack_require__(328);
	var os   = __webpack_require__(357);
	var getAppName = __webpack_require__(367);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var http  = __webpack_require__(369);
	var https = __webpack_require__(370);
	var url   = __webpack_require__(371);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const localShortcut = __webpack_require__(375);
	const isDev = __webpack_require__(382);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const isAccelerator = __webpack_require__(376);
	const equals = __webpack_require__(377);
	const {toKeyEvent} = __webpack_require__(378);
	const _debug = __webpack_require__(379);
